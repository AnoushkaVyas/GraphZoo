...
config_args = {
    'training_config': {
        ...
        'optimizer': ('Adam',  'which optimizer to use, can be any of [Adam, RiemannianAdam, RiemannianSGD]'),
    ...
    'model_config': {
        ...
        'model': ('HNN', 'which encoder to use, can be any of [Shallow, MLP, HNN, GCN, GAT, HGCN]'),
